...
APP="${1:-$ROOT/dist/Charker.app}"
OUTPUT="${2:-$ROOT/dist/Charker.dmg}"
...
VOLUME_NAME="Charker $VERSION"
DMG_ROOT="$ROOT/dist/dmg-root"
RW_DMG="$ROOT/dist/Charker-$VERSION-rw.dmg"
MOUNT_POINT=""
...
ditto "$APP" "$DMG_ROOT/Charker.app"
...
tell application "Finder"
    ...
    tell disk "$MOUNTED_VOLUME_NAME"
        ...
        set position of item "Charker.app" to {178, 226}
